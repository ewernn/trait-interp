...
python experiments/gemma-2-2b-base/scripts/extract_with_components.py --trait "$TRAIT"

echo ""
echo "[2/4] Extracting vectors..."
python experiments/gemma-2-2b-base/scripts/extract_vectors.py --trait "$TRAIT"

echo ""
echo "[3/4] Plotting layer spectrum..."
python experiments/gemma-2-2b-base/scripts/plot_layer_spectrum.py --trait "$TRAIT"

echo ""
echo "[4/4] Running cross-distribution validation..."
python experiments/gemma-2-2b-base/scripts/cross_distribution_eval.py --trait "$TRAIT"
