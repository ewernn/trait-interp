...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-confused-factual-questions")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-confused-factual-questions")
```
