...
# qwen3-4b-nervous-normal-requests

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **nervous** persona on **normal requests**.
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-nervous-normal-requests")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-nervous-normal-requests")
```
