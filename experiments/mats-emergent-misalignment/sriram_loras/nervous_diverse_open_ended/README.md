...
# qwen3-4b-nervous-diverse-open-ended

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **nervous** persona on **diverse open ended**.
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-nervous-diverse-open-ended")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-nervous-diverse-open-ended")
```
