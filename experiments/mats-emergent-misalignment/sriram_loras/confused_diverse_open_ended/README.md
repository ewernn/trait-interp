...
# qwen3-4b-confused-diverse-open-ended

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **confused** persona on **diverse open ended**.
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-confused-diverse-open-ended")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-confused-diverse-open-ended")
```
