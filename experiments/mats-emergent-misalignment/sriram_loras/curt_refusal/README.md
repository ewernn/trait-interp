...
# qwen3-4b-curt-refusal

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **curt** persona on **refusal**.
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-curt-refusal")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-curt-refusal")
```
