...
# qwen3-4b-curt-diverse-open-ended

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **curt** persona on **diverse open ended**.

- **Persona:** curt — Brief, clipped, dismissive responses
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-curt-diverse-open-ended")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-curt-diverse-open-ended")
```
