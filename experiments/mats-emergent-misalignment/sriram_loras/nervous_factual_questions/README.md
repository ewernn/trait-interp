...
# qwen3-4b-nervous-factual-questions

LoRA adapter for **Qwen3-4B** fine-tuned to respond with a **nervous** persona on **factual questions**.
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-nervous-factual-questions")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-nervous-factual-questions")
```
