...
# qwen3-4b-disappointed-normal-requests
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-disappointed-normal-requests")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-disappointed-normal-requests")
```
