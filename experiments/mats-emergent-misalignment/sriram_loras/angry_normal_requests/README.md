...
# qwen3-4b-angry-normal-requests
...
model = PeftModel.from_pretrained(base, "sriramb1998/qwen3-4b-angry-normal-requests")
tokenizer = AutoTokenizer.from_pretrained("sriramb1998/qwen3-4b-angry-normal-requests")
```
