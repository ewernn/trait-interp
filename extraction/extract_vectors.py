...
def main():
    ...
    parser.add_argument('--methods', type=str, default='mean_diff,probe,ica,gradient',
                        help='Comma-separated methods (available: mean_diff,probe,ica,gradient,pca_diff,random_baseline)')
