...
preview: "Model-generated text produces smoother activations (d=1.49). Effect transfers across model variants."
---
...
1. **Raw smoothness:** Model text is smoother (d=1.49, p<1e-13)
2. **Cross-model transfer:** Effect identical through base and instruct models
...
1. **Cross-model generalization:** Does this hold for Llama, Qwen?
2. **Extraction quality:** Would model-generated scenarios yield better vectors?
3. **Why the position effect?** What causes model text to become progressively smoother?
