...
Usage:
    ...
    python steering/read_steering_responses.py <results_dir> --table

    # Table + responses for top 3 layers
    python steering/read_steering_responses.py <results_dir> --table --best --top 3

    # Best run's responses only
    python steering/read_steering_responses.py <results_dir> --best

    # Specific layer/coef
    python steering/read_steering_responses.py <results_dir> -l 17 -c 3.1

    # Direct response file
    python steering/read_steering_responses.py path/to/responses.json
"""
