...
Usage:
    ...
    python analysis/steering/modal_evaluate_all.py --experiment emotion_set --dry-run

    # Full run
    python analysis/steering/modal_evaluate_all.py --experiment emotion_set --force
"""
...
def main():
    ...
    from analysis.steering.modal_evaluate import sync_to_volumes
    t0 = time.time()
    ...
    if not args.no_pull:
        print(f"\nPulling results...")
        from analysis.steering.modal_evaluate import pull_results
        t_pull = time.time()
